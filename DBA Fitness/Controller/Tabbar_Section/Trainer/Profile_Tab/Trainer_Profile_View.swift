...
class Trainer_Profile_View: UIViewController {
    ...
    @IBOutlet weak var myClients_View: UIView!
    ...
    @IBOutlet weak var programSentListView: UIView!
    ...
    override func viewDidLoad() {
        ...
        friend_View.customView(borderWidth:0.5, cornerRadius:4.0,red: 64.0/255, green: 59.0/255, blue: 83.0/255, alpha: 1.0)
        myClients_View.customView(borderWidth:0.5, cornerRadius:4.0,red: 64.0/255, green: 59.0/255, blue: 83.0/255, alpha: 1.0)
    ...
    @IBAction func tappedProgramList(_ sender: UIButton) {
    ...
    @IBAction func myClients(_ sender: UIButton) {
    ...
    @IBAction func myAchievements(_ sender: UIButton) {
        UniversalMethod.universalManager.pushVC(Trainer_Tabbar.Trainer_Achievement.rawValue, self.navigationController, storyBoard: AppStoryboard.Trainer_Tabbar.rawValue)
    }
    ...
    private func addPlayButton(to imageView: UIImageView, for videoURL: URL) {
        ...
        imageView.isUserInteractionEnabled = false // Enable interactions
...
extension Trainer_Profile_View: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout{
...
// MARK: - UnreadNotificationCount
struct UnreadNotificationCount: Codable {
    let status: Int?
    let message, method, data: String?
}
